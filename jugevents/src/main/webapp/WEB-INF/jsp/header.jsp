...
<div id="header">
    ...
    <div id="login_menu">
        ...
        <authz:authorize ifAnyGranted="ROLE_JUGGER">    
            <span class="smallText"><a href="${cp}/jugger/edit.form?jugger.user.username=<authz:authentication operation="username"/>"><spring:message code="Edit-Jugger"/></a></span>
        </authz:authorize>
    </div>
    <!--div id="motto"><spring:message code="slogan"/></div-->

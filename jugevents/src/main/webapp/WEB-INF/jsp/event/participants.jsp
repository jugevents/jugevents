...
<div class="displaytag">
    <display:table name="participants" id="participantList" sort="list" pagesize="20" defaultsort="6" defaultorder="ascending" requestURI="participants.html" export="true">
        ...
        <display:column media="html" titleKey="Attended" sortable="true" headerClass="sortable" style="text-align: center;">
            <input id="conf_att_chk_${participantList.id}" name="conf_att_chk_${participantList.id}" onclick="AjaxMethodsJS.setAttended(${participantList.id}, this.checked)" type="checkbox" <c:if test="${participantList.attended}">checked="checked"</c:if> />
        </display:column>
        <display:column media="html" titleKey="Winner" sortable="true" headerClass="sortable" style="text-align: center;">
            <input id="conf_win_chk_${participantList.id}" name="conf_win_chk_${participantList.id}" onclick="AjaxMethodsJS.setWinner(${participantList.id}, this.checked)" type="checkbox" <c:if test="${participantList.winner}">checked="checked"</c:if> />
        </display:column>
...
<div class="displaytag">
    <display:table name="participantsNotConfirmed" id="participantNotConfirmedList" sort="list" pagesize="20" defaultsort="6" defaultorder="ascending" requestURI="participants.html" export="true">
        ...
        <display:column property="creationDate" titleKey="JoinedAt" sortable="true" headerClass="sortable"/>
        <display:column media="html" titleKey="Attended" sortable="true" headerClass="sortable" style="text-align: center;">
            <input id="notconf_att_chk_${participantList.id}" name="notconf_att_chk_${participantList.id}" onclick="AjaxMethodsJS.confirmParticipantOnAttendance(${participantNotConfirmedList.id}, this.checked, false)" type="checkbox" <c:if test="${participantNotConfirmedList.attended}">checked="checked"</c:if> />
        </display:column>
        <display:column media="html" titleKey="Winner" sortable="true" headerClass="sortable" style="text-align: center;">
            <input id="notconf_win_chk_${participantList.id}" name="notconf_win_chk_${participantList.id}" onclick="AjaxMethodsJS.setWinner(${participantList.id}, this.checked)" type="checkbox" <c:if test="${participantList.winner}">checked="checked"</c:if> />
        </display:column>
        <display:column media="csv xml excel pdf" property="attended" titleKey="Attended" sortable="true" headerClass="sortable" style="text-align: center;" />
        <display:column media="html" title="" sortable="false" style="text-align: center;">
...
<div class="displaytag">
    <display:table name="participantsCancelled" id="participantsCancelledList" sort="list" pagesize="20" defaultsort="6" defaultorder="ascending" requestURI="participants.html" export="true">
        ...
        <display:column media="html" titleKey="Attended" sortable="true" headerClass="sortable" style="text-align: center;">
            <input id="canc_att_chk_${participantList.id}" name="canc_att_chk_${participantList.id}" onclick="AjaxMethodsJS.confirmParticipantOnAttendance(${participantsCancelledList.id}, this.checked, true)" type="checkbox" <c:if test="${participantsCancelledList.attended}">checked="checked"</c:if> />
        </display:column>
        <display:column media="csv xml excel pdf" property="attended" titleKey="Attended" sortable="true" headerClass="sortable" style="text-align: center;" />
        <display:column media="html" title="" sortable="false" style="text-align: center;">

...
@NamedQueries(value = {
		...
		@NamedQuery(name = "Jugger.findByUsernameAndConfirmationCode", query = "from Jugger j where j.user.username = ? and j.confirmationCode = ?"),
		@NamedQuery(name = "Jugger.findByUsernameAndChangePasswordCode", query = "from Jugger j where j.user.username = ? and j.changePasswordCode = ?"),
...
public class Jugger extends EntityBase {
	...
	@OneToOne(cascade = CascadeType.ALL)
	public ReliabilityRequest getReliabilityRequest() {
		return reliabilityRequest;
	}

	public void setReliabilityRequest(ReliabilityRequest reliabilityRequest) {
		this.reliabilityRequest = reliabilityRequest;
	}
}
